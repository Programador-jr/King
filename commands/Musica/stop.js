...
module.exports = {
	...
	category: "Musica",
	aliases: ["leave", "break", "destroy", "dis", "disconnect", "parar"],
	usage: "stop",

	description: "Para de tocar e sai do canal!", //the command description for Slash Command Overview
	cooldown: 5,
			...
			try {
				...
				message.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setTitle(`⏹ **Parou de tocar e saiu do canal!**`)
