...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    functions.embedbuilder(client, 5000, message, config.colors.yes, "Pesquisando e pulando!", "```" + args.join(" ") + "```")
    ...
    else if (args.join(" ").includes("playlist") || args.join(" ").includes("deezer")) return message.reply("**:x: Playlists não são compatíveis com playskip -_-**")
