...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (functions.check_if_dj(message))
            return functions.embedbuilder(client, 6000, message, config.colors.no, "DJ-ROLE", `<:declined:780403017160982538> Você não têm permissão para usar esse comando! você precisa têr: ${functions.check_if_dj(message)}`)
