...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (functions.check_if_dj(message))
            return functions.embedbuilder(client, 6000, message, config.colors.no, "DJ-ROLE", `<a:declined:876968121116807208> Você não têm permissâo para usar este comando, você precisa ter: ${functions.check_if_dj(message)}`)
